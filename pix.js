...
(function () {
  var API = "https://project--9c9f93fa-186d-4cb1-9359-a9fb01eff2a7.lovable.app";
  var CSS =
  ...
  window.abrirPix = function (step, opts) {
    ...
    function gerar() {
      ...
      fetch(API + "/api/public/pix/create", {
        method: "POST",
    ...
    function mostrar(d) {
      ...
      var timer = setInterval(function () {
        fetch(API + "/api/public/pix/status?id=" + encodeURIComponent(d.id))
          .then(function (r) {
            return r.json();
          })
          .then(function (s) {
